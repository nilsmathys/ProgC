...
{
const char *out_txt[] = { "Please give the date in the form: dd mm yyyy !\n" };
...
int year = 2018;
int result =  is_year_leap_year(year);
...
int main(void)
{
TestMainBasic("Folgetag", setup, teardown
